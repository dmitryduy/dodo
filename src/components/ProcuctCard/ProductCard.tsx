...
const ProductCard: FC<ProductCardProps> = ({id, setProductCardOpen, productCardOpen}) => {
        const {doughType, handlePizza, pizzaSize, pizzaCard} = useHandlePizza(id);

        return (
            <ProductContext.Provider value={{doughType, handlePizza, pizzaSize, pizzaCard}}>
                <Modal padding='0' direction='row' cb={setProductCardOpen} value={productCardOpen}>
                    ...
                    <LeftSidebarContainer>
                        ...
                        <AddToCartButton>Добавить в корзину за</AddToCartButton>
                    </LeftSidebarContainer>
                </Modal>
