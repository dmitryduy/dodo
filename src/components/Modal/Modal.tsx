...
import { ProductContainer, ProductContent, CloseButton } from './Modal.styles';
...
const Modal: FC<ModalProps> = ({children, cb, value, direction, padding}) => {
    ...
    return (
        <ProductContainer className={value ? 'visible' : 'hidden'} onClick={closeModal}>
            <ProductContent direction={direction} padding={padding} className={value ? 'visible' : 'hidden'}
